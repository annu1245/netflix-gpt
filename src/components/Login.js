    ...
    return (
        <div>
            ...
            <form className="absolute bg-black w-3/12 my-20 py-10 px-10 mx-auto right-0 left-0 text-white rounded bg-opacity-80">
                ...
                <input 
                  ref={name}
                  type="text" placeholder="Full Name" className="p-2 my-3 w-full bg-gray-700" />}
                <input 
                  ref={email}
                  type="text" placeholder="Email Address" className="p-2 my-3 px-2 w-full bg-gray-700" />
                <input 
                  ref={passoword}
                  type="password" placeholder="Password" className="p-2 my-3 w-full bg-gray-700" />
                <p className="text-red-500 font-bold py-2">{errorMessage}</p>
                <button 
                  onClick={handleClick}
                  className="bg-red-600 p-2 px-4 my-3 w-full rounded-lg">{isSignInForm ? "Sign In" : "Sign Up"}</button>
